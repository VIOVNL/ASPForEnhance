...
namespace ASPForEnhance.SshHelper
{
    ...
    public class SshCommandHelper
    {
            ...
            return await Task.Run(() =>
            {
                ...
                try
                {
                        ...
                        password))
                    {
                        ...
                        using (var cmd = sshClient.CreateCommand("sudo mkdir -p /etc/apache2/vhost_includes"))
                        {
                            cmd.Execute();
                        }
                        ...
                        {
                            string remoteApacheConfigPath = $"/etc/apache2/vhost_includes/{apacheConfigFileName}";
        ...
        {
            // Define regex patterns to extract metadata Pattern to match: # [ASPForEnhance Name = "websitename.com"]
        ...
        private ServiceStatus ParseServiceStatusOutput(string output, string serviceName)
        {
            ...
            // Extract other useful information Capture memory usage and peak memory usage
